...
cd /home/yehlab/projs/project_ya/Project_mol_embedding/FeatureNet_mol_embedding/src/eval/

RESULTS_PATH="experiments/results_RF_sklearn"

echo "start to evaluate RandomForest (sklearn API)..."
...
python -u evaluate_RF_sklearn.py \
    --dataset BBBP \
    --fingerprint MACCS \
